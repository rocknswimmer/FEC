...
import SelectedStyle from '../client/src/components/View/SelectedStyle.jsx';
...
describe('it should show all the styles mapped into pictures', () => {
  it('render all the mapped images', () => {
    render(
      <SelectedStyle
        otherStyles={dummyOtherStyles}
        productId={dummyProductInfo.id}
        currentDisplayedStyle={dummyCurrentDisplayedStyle}
      />
    );
    expect(screen.getAllByTestId('round_image')).toHaveLength(6);
...
// it('flags the default style with a red check mark', () => {
//   render(
//     <SelectedStyle
//       otherStyles={dummyOtherStyles}
//       productId={dummyProductInfo.id}
...
//     />
//   );
//   const defaultStyle = screen.getAllByTestId('image')[0];
//   // console.log(defaultStyle, 'can i console.log this defaultStyle');

//   const descendant = screen.getByTestId('checkmark');
//   // const nonExistantElement = getByTestId('does-not-exist');
//   console.log(descendant, 'can i console.log this de');

//   expect(defaultStyle).toContainElement(descendant);
