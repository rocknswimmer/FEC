...
import ExpandedPhoto from '../client/src/components/View/ExpandedPhoto.jsx';
...
describe('Handle and expanded image', () => {



  it('should render main image component', () => {
    render(
      <ExpandedPhoto
        displayedImage={'https://images.unsplash.com/photo-1448526478325-616f2b15b04e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1567&q=80'} photoIndex={0}
        lengthOfImageArray={6}
        imageArray={dummyCurrentDisplayedStyle.photos}
      />
    );

    expect(screen.getByTestId('modal')).toHaveAttribute('src');
  });

  it('should render correct number of dots for expanded image icons', ()=> {
    render(
      <ExpandedPhoto
        displayedImage={'https://images.unsplash.com/photo-1448526478325-616f2b15b04e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1567&q=80'} photoIndex={0}
        lengthOfImageArray={6}
