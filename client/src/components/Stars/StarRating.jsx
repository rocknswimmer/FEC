      ...
      <div className="stars-container">
        ...
        {[...Array(5)].map((star, i) => {
          ...
          if (countDown - ratingValue >= .875) {
            return (
              <svg key={i + 'a'} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 576 512" className="one,star" color="#ffc107" size="20" height="20" width="20" xmlns="http://www.w3.org/2000/svg" style={{'color': 'rgb(255, 193, 7)'}}>
            ...
            return (
              <svg key={i + 'b'}stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 576 512" className="one,star" color="#ffc107" size="20" height="20" width="20" xmlns="http://www.w3.org/2000/svg" style={{'color': 'rgb(255, 193, 7)'}}>
            ...
            return (
              <svg key = {i + 'c'} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 576 512" className="one,star" color="#ffc107" size="20" height="20" width="20" xmlns="http://www.w3.org/2000/svg" style={{'color': 'rgb(255, 193, 7)'}}>
